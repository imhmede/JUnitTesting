...
public class Main {
   ...
   public static void main(String[] args) {        
      double[] sequenceA = readInputs(5);
      multiply(sequenceA, 10);
      printReversed(sequenceA);
   }
   ...
   */
    ...
    */
   public static void printReversed(double[] sequenceV) {
      // Traverse the array in reverse order, starting with the last element
      for (int i = sequenceV.length - 1; i >= 0; i--) {
